...
class Agent():
    ...
    def choose_action(self, observation):
        ...
        sigma = T.exp(sigma)
        action_props = T.distributions.Normal(mu, sigma)
        probs = action_props.sample(sample_shape=T.Size([self.n_outputs]))
        self.log_probs = action_props.log_prob(probs).to(self.actor.device)
        action = T.tanh(probs)
...
if __name__ == '__main__':
    ...
    for i in range(num_episodes):
        ...
        filename = 'mountaincar-continuous-old-actor-critics2.png'
