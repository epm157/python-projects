...
classifier.add(hub.KerasLayer(classifier_url, input_shape=IMAGE_SHAPE+(3,)))
...
plt.imshow(np.asarray(grace_hopper))
plt.axis('off')
...
reloaded = tf.keras.experimental.load_from_saved_model('model', custom_objects={'KerasLayer':hub.KerasLayer})
